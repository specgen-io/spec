...
`
	...
	assert.Equal(t, reflect.DeepEqual(param1.Type.Type, ParseType("string")), true)
	assert.Equal(t, *param1.Description, "some param")

	assert.Equal(t, param2.Name.Source, "param2")
	assert.Equal(t, reflect.DeepEqual(param2.Type.Type, ParseType("string")), true)
	assert.Equal(t, *param2.Description, "some param")

	assert.Equal(t, param3.Name.Source, "param3")
	assert.Equal(t, reflect.DeepEqual(param3.Type.Type, ParseType("string")), true)
